...
app.config['MYSQL_USER'] = 'MzwGObly39'
app.config['MYSQL_PASSWORD'] = '16C1AE1tq0'
app.config['MYSQL_DB'] = 'MzwGObly39'
mysql = MySQL(app)
...
def statistics():
    ...
    p_h = figure(x_range=fruits, y_range=(0,max(counts)*2), plot_height=250, title="Things counts",
           toolbar_location=None, tools="")

    p_h.vbar(x='fruits', top='counts', width=0.9, color='color', source=source)
